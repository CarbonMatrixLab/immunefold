...
from immunefold.model.lm.rotary_embedding import RotaryEmbedding
from immunefold.model.common_modules import Linear
...
class MultiheadAttention(E.MultiheadAttention):
    ...
    def forward(
        ...
        attn_weights_float = E.utils_softmax(attn_weights, dim=-1, onnx_trace=self.onnx_trace)
